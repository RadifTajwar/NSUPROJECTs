...
import story_image from '../../../public/story/1.png';
        ...
        <div id="get-supporter" phx-hook="GetSupporter">
          ...
          <div data-phx-component="1" id="298086e0-3dc9-450c-94dc-92172d281c01" className="">
            <div className="h-screen">
              <div style={{ backgroundImage: "url('/story/1.png')"}} className="absolute h-full w-full opacity-50 brightness-50" ></div>

              <div className="pt-36">
                <a href="" id="cover" className="book-container animate-fall" >
                  <div className="book relative hover:rotate-0 flex justify-center">
                    <Image className=" w-[400px] h-[500px] transform translate-z-0 border-md rounded-lg brightness-75" style={{ transform: 'translateZ(25px)' }} alt=" The Tiger Who Flew Too Close to the Mouse" src={story_image} />
                    <div style={{ transform: 'translateZ(25px)' }} className="absolute text-white w-[400px] h-[500px] z-50 text-center mt-16">
                      <h1 className="px-8"> The Tiger Who Flew Too Close to the Mouse</h1>
                      <p className="text-sm">By You &amp; Robot</p>
                    </div>
                  </div>
                </a>
